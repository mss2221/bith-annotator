...
export default {
  ...
  mounted: function () {
    ...
    const createViewer = (id, pageArr) => {
      ...
      this.anno.on('createAnnotation', (a) => {
        console.log('created a new annotation')
        console.log(a)

        const xywh = a.target.selector.value.substr(11).split(',')
      ...
      this.anno.on('updateAnnotation', (a) => {
     ...
     */
    const preparePage = (pageObj, viewer) => {

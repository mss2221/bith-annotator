...
export const graphURI = 'http://localhost:8082/rdf/BitHCollection.jsonld' // 'https://beta.domestic-beethoven.eu/rdf/BitHCollection.jsonld' // 'http://localhost:8082/rdf/BitHCollection.jsonld'
